...
<template>
    <div id="page-instituicoes" class="container-fluid">
...
export default {
    ...
    methods: {
        ...
        editStartCompleteFilds( instituicao )
        {
            console.log('testestess', instituicao);
            this.entity = instituicao.id;
            this.fetrafi = instituicao.fetrafi;
            ...
            setTimeout(function(){
                textoCkeditor.setData(instituicao.texto);
            }, 1500);
        },
