...
<template>
    <div class="entidades-parceiras">
        
        <div class="row">
            <div class="col-12">
                <div class="box-btns-entidades-parceiras">
                ...
                <div class="row">
                    ...
                    <template v-if="this.list.length">    
                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2" v-for="item in list" :key="item.id">
                            ...
                            <div class="box--entidade-parceira entidade-parceira">
                                
                                
                                <div class="imagem-entidade-parceira" :style="{ backgroundImage: `url(/${item.file_pathfile}/${item.file_namefile})` }"></div>
                    ...
                    <template v-else>
                        <div class="col-12">
                            <div class="box--entidade-parceira">
                                <div class="content">
...
.entidades-parceiras
{
    ...
    .box--entidade-parceira
    {
        position: relative;
        border-bottom: solid 1px $grey-light;

        .imagem-entidade-parceira {
            width: 100%;
            height: 100px;
