        ...
        <div class="col-12 col-md-6 __news--box">
            <div class="__news--content">
                ...
                <div class="SHARED__icons__socials--midia">
                    ...
                    <div class="d-block d-lg-none"> <a title="Whatsapp" title="Whatsapp" href="whatsapp://send?text={{$item->titulo}} - {{url("/editais")}}" ><img src="{{asset('/_site/assets/SVGs/Whatsapp-Vertical.svg')}}" class="img-fluid" onload="SVGInject(this)" /></a> </div>
                </div>
