...
class CreateAcordosEConvencoesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('acordos_e_convencoes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('acordos_e_convencoes');
    }
}
